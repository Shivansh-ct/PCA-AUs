...
def plot_landmarks(landmarks, axis=None, color='k', title=None):
    ...
    ax.plot(landmarks[48:59,0], landmarks[48:59,1], color)  # outer mouth
    ax.plot([landmarks[59,0], landmarks[48,0]], 
            [landmarks[59,1], landmarks[48,1]], color)  # close outer mouth
    
    ax.plot(landmarks[60:66,0], landmarks[60:66,1], color)  # inner mouth
    ax.plot([landmarks[65,0], landmarks[48,0]], 
            [landmarks[65,1], landmarks[48,1]], color)  # close inner mouth
